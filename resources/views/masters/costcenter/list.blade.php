				  ...
				  <div class="container">
					<div class="row">
					  <div class="col s10 m6 l6">
						<h5 class="breadcrumbs-title mt-0 mb-0"><span>Cost Center</span></h5>
						<ol class="breadcrumbs mb-0">
						  <li class="breadcrumb-item"><a href="#">Dashboard</a>
						  </li>
						  <li class="breadcrumb-item active">Cost Center List
						  </li>
						</ol>
					  </div>
					  <div class="col s2 m6 l6">
							<a href="{{ route('costcenternew') }}" class="btn waves-effect waves-light breadcrumbs-btn right" ><i class="material-icons hide-on-med-and-up">settings</i> Add </a>
					  </div>
					</div>
				  </div>
				</div>
									  ...
									  <table id="memberprofilelist_datatable" class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													@php
													$enc_id = Crypt::encrypt($cost->id);
                 									$edit = route('editcostcenter',$enc_id);
													@endphp
													<p>
														<a href="{{$edit}}" style="float:left"><i class="material-icons" style="color: #00bcd4!important;">edit</i></a>
														<a style="float:left"></a>
													</p>
													<form style="display:inline-block;" action="{{ route('Costcenterdestroy',$enc_id) }}" method="POST"><a style="float:left">    
														@csrf
                  										@method('DELETE')
