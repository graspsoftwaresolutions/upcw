						  ...
						  <div id="validations" class="card card-tabs">
							<div class="card-content">
							  <div class="card-title">
                                ...
                                @php $row = $data['company_view'][0]; @endphp
								<form class="formValidate" id="formValidate" method="POST" action="{{ route('updatecompany') }}">
									...
									<div class="row">
										<div class="input-field col m6 s6">
										  ...
										  <input id="company_name" value="{{$row->company_name}}" name="company_name" type="text" data-error=".errorTxt1">
