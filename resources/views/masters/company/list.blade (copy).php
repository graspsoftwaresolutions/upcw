				  ...
				  <div class="container">
					<div class="row">
					  ...
					  <div class="col s2 m6 l6">
							<a href="{{ route('companysave') }}" class="btn dropdown-settings waves-effect waves-light breadcrumbs-btn right" ><i class="material-icons hide-on-med-and-up">settings</i> Add </a>
					  </div>
					</div>
				  </div>
				</div>
