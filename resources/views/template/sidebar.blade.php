  ...
  <!-- BEGIN: SideNav-->
    ...
    <aside id="collapsible_expen" class="sidenav-main nav-collapsible sidenav-light nav-collapsed">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper" style="text-align: center;"><a class="brand-logo darken-1" href="#" style="padding: 5px 12px 22px 0px;position:unset;"><img class="hide-on-med-and-down" src="{{ asset('public/img/logo.png') }}" alt="logo" style="height:40px"><img class="show-on-medium-and-down hide-on-med-and-up" src="{{ asset('public/img/logo.png') }}" alt="logo" style="height:30px"><!--span class="logo-text hide-on-med-and-down">Nuteaiw</span--></a><!--a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a--></h1>
      </div>
